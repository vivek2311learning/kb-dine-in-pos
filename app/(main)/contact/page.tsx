    ...
    <Container className="py-16 space-y-20">
      ...
      <section className="max-w-2xl space-y-4">
        ...
        <p className="text-[#3b2a1a]/80 leading-relaxed">
          ...
          occasion, or simply exploring great food — we'd love to welcome you.
          Find our location, contact details, and reservation options below.
        </p>
      ...
      <section className="grid md:grid-cols-2 gap-12 items-start">
        ...
        <Card className="p-10 space-y-8 border-[#3b2a1a]/20">
          ...
          <h2 className="font-rustic text-2xl">
      ...
      <section className="grid sm:grid-cols-3 gap-6">
        ...
        <Card className="p-6 text-center space-y-4">
          ...
          <h3 className="font-rustic text-xl">
            Call Us
          </h3>
      ...
      <section className="text-center space-y-6 max-w-2xl mx-auto">
        ...
        <p className="text-sm text-[#3b2a1a]/80 leading-relaxed">
          Our team is here to help with reservations, menu inquiries,
          private events, and any questions you may have.
          Don't hesitate to reach out — we're always happy to assist.
        </p>
